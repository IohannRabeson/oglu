...
/*   Updated: 2015/09/12 10:39:06 by irabeson         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main( void )
{
	...
	try
	{
		vertShader.setSource(readEntireFile("shaders/simple.vert"));
		fragShader.setSource(readEntireFile("shaders/simple.frag"));
		vertShader.compile();
		fragShader.compile();
